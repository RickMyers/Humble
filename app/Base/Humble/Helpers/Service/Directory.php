<?php
namespace Base\Humble\Helpers\Service;
/**
 *
 ...
 */
class Directory extends \Base\Humble\Helpers\Directory
{
    ...
    public function generate() {
        ...
        foreach ($packages as $package) {
            ...
            foreach ($modules as $module) {
                ...
                $views       = $mod['views'];
                $directory   = ''.str_replace('_','/',$package.'_'.$controllers);
                $viewsDir    = ''.str_replace('_','/',$package.'_'.$views);
                if (!is_dir($directory)) {
                    continue;
                }
                $dir = dir($directory);
