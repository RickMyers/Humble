            ...
            <form name="config-file-add-form" id="config-file-add-form-{$data.id}" onsubmit="return false">
                ...
                <table>
                    <tr><td>
                            ...
                            Write Location: <input type="text" name="file_output_location" id="config_file_output_location_{$data.id}" value="{if (isset($data.file_output_location))}{$data.file_output_location}{/if}" /><br /><br >
...
<script type="text/javascript">
    Form.intercept($('#config-file-add-form-{$data.id}').get(),'{$data.id}','/paradigm/element/update',"{$helper->getWindowId()}");
</script>