var Administration = (function () {
                ...
                return {
                    ...
                    cadence: {
                        action: function (action) {
                            if (action) {
                                (new EasyAjax('/humble/cadence/'+action)).then((response) => {
                    ...
                    maintenance: {
                        enter: function () {
                            if (confirm('This action will swap the login page for the maintenance page essentially putting the site into maintenance mode.\n\nDo you wish to continue?')) {
                                (new EasyAjax('/humble/admin/maintenance')).add('enable','Y').then((response) => {
                                    alert(response);
                                }).post();
                            }
                        },
                        leave: function () {
                            if (confirm('This action will restore the login page.\n\nDo you wish to continue?')) {
                                (new EasyAjax('/humble/admin/maintenance')).add('enable','N').then((response) => {
                                    alert(response);
                                }).post();
                            }
                        }
                    ...
                    change: {
                        state: function (cs) {
                            if (confirm('Would you like to put the site in '+$(cs).val()+' mode?')) {
                                (new EasyAjax('/humble/system/state')).add('state',$(cs).val()).then((response) => {
                    ...
                    api: {
                        tester: function () {
                            ...
                            (new EasyAjax('/humble/test/apitester')).then((response) => {
                                win._open(response);
                            }).get();                              
                        }
                    },
                    module: {
                        import: function (namespace) {
                            ...
                            (new EasyAjax('/humble/admin/importpage')).then((response) => {
                        ...
                        install: function (namespace) {
                            let win = Desktop.semaphore.checkout(true);
                            (new EasyAjax('/humble/admin/installpage')).then((response) => {
                    ...
                    secrets: {
                        add: function () {
                            ...
                            (new EasyAjax('/humble/secrets/form')).then((response) => {
                                win._open(response);
                            }).get();                              
                        },
                        review: function () {
                            var win = (Administration.create.win.sec = Administration.create.win.sec ? Administration.create.win.sec : Desktop.semaphore.checkout(true))._static(true)._title("New Secret");
                            (new EasyAjax('/humble/secrets/review')).then((response) => {
                                win._open(response);
                            }).get();                              
                        }
                    },
                    tests: {
                        ...
                        home: function () {
                            ...
                            (new EasyAjax('/humble/unittests/home')).add('window_id',win.id).then((response) => {
                                win._open(response);
                            }).get();                              
                        }
                    },
                    ...
                    create: {
                        ...
                        package: function () {
                            ...
                            (new EasyAjax('/humble/admin/package')).then((response) => {
                                win._open(response);
                            }).get();
                        },
                        module: function () {
                            ...
                            (new EasyAjax('/humble/admin/module')).then((response) => {
                                win._open(response);
                            }).get();                            
                        },
                        component: function () {
                            ...
                            (new EasyAjax('/humble/admin/component')).then((response) => {
                                win._open(response);
                            }).get();                            
                        },
                        controller: function () {
                            ...
                            (new EasyAjax('/humble/admin/controller')).then((response) => {
                                win._open(response);
                            }).get();                            
                        }
                    },
                    documentation: {
                        run: function () {
                            if (confirm("Are you sure you want to run the docs?  It could take a while...")) {
                                ...
                                (new EasyAjax('/humble/documentation/generate')).add('window_id',win.id).then((response) => {
                                    win.set(response);
                                }).post();
                            }
                        },
                        review: function () {
                            ...
                            (new EasyAjax('/humble/documentation/review')).add('window_id',win.id).then((response) => {
                                win.set(response);
                            }).post();
                        }
                    },
                    ...
                    templates: {
                        clone: function () {
                            if (confirm("Do you wish to clone a copy of the framework component templates so that you may customize them?\n\nIf so, they will be in the 'lib' directory of your main application module.")) {
                                (new EasyAjax('/humble/admin/clone')).then((response) => {
                                    alert(response);
                                }).post();
                            }
                        }
                    ...
                    upload: {
                        ...
                        form: function () {
                            ...
                            (new EasyAjax('/humble/upload/form')).then((response) => {
                    ...
                    smtp: {
                        settings: {
                            ...
                            open: function ()  {
                                ...
                                (new EasyAjax('/humble/smtp/settings')).then((response) => {
                                    win._open(response);
                                }).get();
                            }
                        }
                    ...
                    status: {
                        check: function () {
                            (new EasyAjax('/humble/system/info')).then((response) => {
                        ...
                        quiesce: {
                            ...
                            countdown: function () {
                                ...
                                if (Administration.status.quiesce.counter) {
                                    ...
                                    $("#quiesce-box").fadeOut();
                                    (new EasyAjax('/humble/system/offline')).add('value',0).then((response) => {
                                        (new EasyAjax('/humble/system/quiesce')).add('value',0).then((response) => {
                            ...
                            start:                             function () {
                                ...
                                if (confirm("Do you wish to begin shutting down the system?")) {
                                    (new EasyAjax('/humble/system/quiesce')).add('value','1').then((response) => {
                                        $("#quiesce-box").fadeIn();
                ...
                /*    events: {
                        open: function () {
                            ...
                            win._open();
                            (new EasyAjax('/humble/events/open')).add('window_id',win.id).then((response) => {
                                win.set(response);
                        ...
                        fetch: function (page,rows,win) {
                            ...
                            rows = rows ? rows : 30;
                            (new EasyAjax('/humble/events/fetch')).add('page',page).add('rows',rows).then((response) => {
                                if (response) {
                        ...
                        expand: function (win_id,id,name) {
                            ...
                            (new EasyAjax('/humble/event/expand')).add('id',id).add('name',name).then((response) => {
                    ...
                    events: {
                        template: false,
                        home: function () {
                            (new EasyAjax('/humble/events/home')).add('page',1).add('rows',30).then((response) => {
                    ...
                    workflows: {
                        ...
                        fetch: function () {
                            (new EasyAjax('/humble/workflows/list')).then((response) => {

                            }).post();
                        },
                        generate: function () {
                            (new EasyAjax('/humble/workflows/generate')).then((response) => {

                            }).post();
                        },
                        remove: function () {
                            (new EasyAjax('/humble/workflows/remove')).then((response) => {

                            }).post();
                        },
                        activate: function () {
                            (new EasyAjax('/humble/workflows/activate')).then((response) => {

                            }).post();
                        },
                        deactivate: function () {
                            (new EasyAjax('/humble/workflows/deactivate')).then((response) => {
                    ...
                    users:      {
                        list:   function () {
                            (new EasyAjax('/humble/users/list')).then((response) => {
                                $E('user_list').innerHTML = response;
                            }).post();
                        },
                        remove: function (uid) {
                            var ss = prompt('Please enter the super secret pass phrase');
                            (new EasyAjax('/humble/users/remove')).add('secret',ss).add('uid',uid).then((response) => {
                                $E('user_list').innerHTML = response;
                            }).post();
                        }
                    },
...
/*                    create:     function (directory,pkg) {
                    ...
                    update: function (pkg,root,namespace) {
                       if (confirm('This action will update the module '+root+'.\n\nThis will run any recent update SQL statements.\n\nAre you sure you wish to continue?')) {
                           $('#admin-lightbox-output').html('Working...');
                           $('#admin-lightbox').css('display','block');
                           (new EasyAjax('/humble/utilities/update')).add('namespace',namespace).add('root',root).add('package',pkg).then((response) => {
                               $('#admin-lightbox-output').html(response);
                           }).post();
                       }
                    },
                    compile: function (pkg,root,namespace) {
                       if (confirm('This action will compile the controllers for module '+root+'.\n\nAre you sure you wish to continue?')) {
                           $('#admin-lightbox').css('display','block');
                           $('#admin-lightbox-output').html('Working...');
                           (new EasyAjax('/humble/utilities/compile')).add('namespace',namespace).add('root',root).add('package',pkg).then((response) => {
                               $('#admin-lightbox-output').html(response);
                           }).post();
                       }
                    },
                    clearcache: function (pkg,root,namespace) {
                       if (confirm('This action will clear the cache for the module.\n\nAre you sure you wish to continue?')) {
                           $('#admin-lightbox').css('display','block');
                           $('#admin-lightbox-output').html('Working...');
                           (new EasyAjax('/humble/utilities/clear')).add('namespace',namespace).add('root',root).add('package',pkg).then((response) => {
                               $('#admin-lightbox-output').html(response);
                           }).post();
                       }
                    },
                    ...
                    logs: {
                        ...
                        users: {
                            open: function (win,win_id) {
                                (new EasyAjax('/humble/admin/users')).add('viewing',win).add('window_id',win_id).then((response) => {
                            ...
                            fetch: function (user_id,user_name) {
                                ...
                                (new EasyAjax('/humble/log/users')).add('log','user').add('user_id',user_id).then((response) => {
                                    win.set(response);
                                }).post();
                            }
                        },
                        open: function (log) {
                            ...
                            (new EasyAjax('/humble/admin/log')).add('log',log.toLowerCase()).add('window_id',win.id).then((response) => {
                                win.set(response);
                            }).post();
                        },
                        clear: function (log) {
                            if (confirm('Clear the '+log.charAt(0).toUpperCase() + log.slice(1)+' log?')) {
                                (new EasyAjax('/humble/log/clearlog')).add('log',log.toLowerCase()).then((response) => {
                                    alert(response);
                                }).post();
                            }
                        },
                        fetch: function (log,win_id) {
                            var win     = Desktop.window.list[win_id];
                            win.viewing = log;
                            (new EasyAjax('/humble/log/fetch')).add('log',log.toLowerCase()).add('size',100000).then((response) => {
