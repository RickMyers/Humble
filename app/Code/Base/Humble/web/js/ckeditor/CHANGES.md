...
* [#13771](http://dev.ckeditor.com/ticket/13771): Fixed: The `/ckeditor/contents.css` style is not used if the [IFrame Editing Area](http://ckeditor.com/addon/wysiwygarea) plugin is missing.
...
* [#11204](http://dev.ckeditor.com/ticket/11204): Added `figure` and `figcaption` styles to the `/ckeditor/contents.css` file so [Enhanced Image](http://ckeditor.com/addon/image2) looks nicer.
