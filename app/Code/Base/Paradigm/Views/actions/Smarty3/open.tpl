...
Copyright Enicity.com, all rights reserved
            ...
            return {
                ...
                remove: function (workflow_id) {
                    ...
                    if (confirm('Are you sure you want to delete that workflow?')) {
                        (new EasyAjax('/paradigm/workflow/delete')).add('id',workflow_id).callback(function (response){
                ...
                load: function (id,namespace) {
                    ...
                    (new EasyAjax('/paradigm/workflow/load')).add('id',id).callback(function (response) {
                ...
                fetch: function (ns,page) {
                    ...
                    if (ns) {
                        Workflows.clear();
                        (new EasyAjax('/paradigm/workflow/inventory')).add('page',page).add('namespace',ns).callback(function (response) {
