...
Paradigm.actions = (function () {
    ...
    return {
        ...
        new: function () {
            ...
            (new EasyAjax('/paradigm/diagram/new')).add('winId',newDiagramWindow).callback(function (response) {
        ...
        list: function () {
            ...
            (new EasyAjax('/paradigm/workflow/list')).add('winId',loadWindow).callback(function (response) {
        ...
        details: function () {
            ...
            (new EasyAjax('/paradigm/workflow/details')).add('id',Paradigm.actions.get.currentDiagramId()).add('winId',saveWindow).callback(function (response) {
        ...
        quickSave: function () {
            (new EasyAjax('/paradigm/workflow/quicksave')).add('namespace',Paradigm.actions.get.namespace()).add('workflow',JSON.stringify(Paradigm.elements.list)).add('id',currentDiagramId).add('image',Paradigm.canvas.toDataURL()).callback(function (response) {
                if (response) {
        ...
        activate: function () {
            (new EasyAjax('/paradigm/workflow/activate')).add('id',Paradigm.actions.get.currentDiagramId()).callback(function (response) {
        ...
        inactivate: function () {
            (new EasyAjax('/paradigm/workflow/inactivate')).add('id',Paradigm.actions.get.currentDiagramId()).callback(function (response) {
        ...
        generate: function () {
            ...
            (new EasyAjax('/paradigm/workflow/generate')).add('namespace',Paradigm.actions.get.namespace()).add('windowId',generateWindow).add('workflow',JSON.stringify(Paradigm.elements.list)).add('id',currentDiagramId).add('image',Paradigm.canvas.toDataURL()).callback(function (response) {
        ...
        delete: function () {
            if (confirm('Do you really want to delete this workflow?\n\n"'+Paradigm.actions.get.diagramTitle()+'"')) {
                (new EasyAjax('/paradigm/workflow/delete')).add('id',Paradigm.actions.get.currentDiagramId()).callback(function (response) {
        ...
        import: function () {
            ...
            (new EasyAjax('/paradigm/workflow/import')).add('namespace',Paradigm.actions.get.namespace()).add('windowId',win.id).add('workflow',JSON.stringify(Paradigm.elements.list)).add('id',currentDiagramId).add('image',Paradigm.canvas.toDataURL()).callback(function (response) {
        ...
        export: function () {
            ...
            (new EasyAjax('/paradigm/workflow/quicksave')).add('namespace',Paradigm.actions.get.namespace()).add('workflow',JSON.stringify(Paradigm.elements.list)).add('id',currentDiagramId).add('image',Paradigm.canvas.toDataURL()).callback(function (response) {
                if (response) {
                    ...
                    (new EasyAjax('/paradigm/workflow/exportlist')).add('windowId',win.id).add('id',currentDiagramId).callback(function (response) {
        ...
        sync: function () {
            var win = Desktop.semaphore.checkout(true);
            (new EasyAjax('/paradigm/workflow/synclist')).add('windowId',win.id).callback(function (response) {
