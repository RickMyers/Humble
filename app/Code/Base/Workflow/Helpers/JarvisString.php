<?php
namespace Code\Base\Workflow\Helpers;
use Humble;
/**   
 *    
 * String utilities
...
class HumbleString extends Helper implements \Countable, \ArrayAccess, \IteratorAggregate
{
    ...
    /**
     * Muli-purpose funtion to return either the array length or string length of a passed in value or the default private string
     *
     * @param mixed $what
     * @return int
     */
