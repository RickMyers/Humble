<script type="text/javascript">
    ...
    (new EasyAjax('/paradigm/element/configure')).add('namespace','{$manager->getNamespace()}').add('window_id',winId).add('id','{$manager->getId()}').add('type','{$manager->getType()}').callback(function (response) {
