    ...
    <div class="m-auto bg-blue-500 p-2 w-[700] text-justify text-md">
        ...
        <form name="new_module_form" id="new_module_form" onsubmit="return false" >
            <select name="package" id="package" class="p-2 font-sans text-slate-900 w-[600] rounded-sm">
                <option v-for="package in packages" value="{{ package.value }}"> {{ package.text }} </option>
            </select>   
            ...
            <div class='font-mono pb-2 text-slate-1000'>Module Name Prefix</div>
            <input type="text" name="prefix" id="prefix" class="p-2 font-sans text-slate-900 w-[600] rounded-sm"/><br />
            <div class='font-mono pb-2 text-slate-1000'>Database Prefix</div>
