<div style="margin-left: auto; margin-right: auto; width: 100%; padding: 5px 20px">
    <form name="fetch_secret_form" id="fetch_secret_form" onsubmit="return false">
        <fieldset><legend>Review Secrets</legend>
            ...
            <div class="w-3/4" style="background-color: lightcyan; position: relative">
                <img id='toggle_hidden_switch' v-on:click="toggle(this)" title="Toggle Password Visibility" src="/images/admin/hide_show.png" style="height: 30px; position: absolute; right: 0px; top: 0px; z-index: 9; margin-right: 5px; cursor: pointer" />
