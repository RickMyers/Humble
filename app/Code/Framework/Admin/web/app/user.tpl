    ...
    <div class="w-full">    
        <div class="text-base font-sans inline-block m-auto text-center">
            <form name="user_avatar_form" id="user_avatar_form" onsubmit="return false">
                <input type="file" name="user_photo" class="standard-field w-48" />&nbsp;
    ...
    <div class="border-2">
        <div class="w-full border-2">
            ...
            <div class="pl-4 text-lg">
                <input type="text" class="w-full" name="password" id="user_last_name"  :value="last_name" />
            </div>        
        </div>
        <div class="w-full border-2">
            <div class="text-sm mono">
...
</div><div class="w-40 box-border border-2">
    <div class="w-full">
        <div class="w-full border-2">
            <div class="text-sm mono">
                First Name
