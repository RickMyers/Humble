...
SQL;
    ...
    /**
     * Will delete the current crop of workflow components/comments associated to a module
     * 
    ...
    protected function deRegisterWorkflowComponents($namespace=false) {
        if ($namespace = ($namespace) ? $namespace : (($this->namespace) ? $this->namespace : null)) {
            Humble::entity('paradigm/workflow/components')->setNamespace($namespace)->delete(true);
            Humble::entity('paradigm/workflow/comments')->setNamespace($namespace)->delete(true);
        }
        return $this;
    }
   ...
   /**
    ...
    private function deregisterExternalComponents() {
        print("Deregistering\n");
        Humble::entity('paradigm/workflow/components')->namespaceLike('/')->delete();
        Humble::entity('paradigm/workflow/comments')->namespaceLike('/')->delete();
        return $this;
    }
    ...
    /**
     * We will now register components located in directories not part of the framework or application
     * 
     * @return $this
     */
