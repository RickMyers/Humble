...
Module: Core.<br />
Namespace: core<br />
Author: &lt;rick@humbleprogramming.com&gt;</h3>

Welcome to the home page of your application. Some useful information is below:<br />
<ul>
    <b>Configuration</b>:<br /><br />
    
    &nbsp;&nbsp;&nbsp;app/Code/Framework/Humble/etc/config.xml<br /><br />
    
    <b>Main View</b>:<br /><br />
    
    &nbsp;&nbsp;&nbsp;app/Code/Framework/Humble/Views/actions/Smarty3/open.tpl<br /><br />

    <b>JavaScript File</b>:<br /><br />
    
    &nbsp;&nbsp;&nbsp;app/Code/Framework/Humble/web/js/actions.js<br /><br />
    <b>Tutorials</b>:
    <ul>
