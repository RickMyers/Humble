	...
	<body>
		...
		<div style='font-size: 4.5em;  margin-left: auto; margin-right: auto; margin-top: 50px;  text-align: center'>Humble.</div>
    		...
    		Humble is released to the public under a <a href='https://www.gnu.org/licenses/gpl-3.0-standalone.html' target='_BLANK'>GNU GPL v3 License</a>.
                    ...
                    <ul>
                        <li> /app/Code/Framework/Humble/Views/landing/Smarty/page.tpl - location for the main page of your Single Page Application</li>
                        <li> /app/Code/Framework/Humble/Views/landing/Smarty/index.tpl - this is your "index.html" initial landing page</li>
                        <li> /app/Code/Framework/Humble/Views/landing/Smarty/404.tpl - this is your 404 "Page Not Found" page</li>
                        <li> /app/Code/Framework/Humble/Views/landing/Smarty/register.tpl - this page lets others register, you should probably override it</li>
                        <li> /app/Code/Framework/Humble/Views/landing/Smarty/maint.html - when site is in maintenance mode, this replaces the index.html</li>
                        <li> /app/Code/Framework/Humble/Views/landing/Smarty/recover.tpl - the "Forgot My Password" page, starts the recovery process</li>
