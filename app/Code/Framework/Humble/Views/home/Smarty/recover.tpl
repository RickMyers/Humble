...
<head>
  <meta charset="UTF-8">
  <title>Acme | Password Recovery</title>
                        ...
                        <td>
                            <div id='card' class="recover-card">
                                ...
                                <div style="padding: 10px 40px 10px 40px">
                                    ...
                                    <form name='recover-form' id='recover-form' onsubmit='return false'  action='/acme/landing/recover/action' method='POST'>
                                    ...
                                    <div class="recover-help">
                                        <a href="/acme/landing/register">Register</a> • <a href="/index.html">Login</a>
                                    </div>
                                </div>
