    ...
    <tr>
        <td align='center' valign='middle'>
            ...
            <div style='width: 600px; margin-left: auto; margin-right: auto; background-color: #4F8DC0; color: white; padding: 0px 20px 20px 20px; text-align: left'>
                <form name='new-diagram-form' id='new-diagram-form' onsubmit='return false'>
                    <select name='client'>
                    ...
                    Description<br /><br />
                    <label title="A partial workflow is one that is meant to be called from another workflow using an off-page connector">
                        <input type="checkbox" name="partial" value='Y' /> This will be a partial workflow</label><br /><br />
