                ...
                <table>
                    <tr>
                        <td>Return:&nbsp;&nbsp;&nbsp;<input type="radio" name="returns" {if (isset($data.returns)&& ($data.returns== 1))}checked="checked"{/if} id="terminus-value-true-{$id}" value='1' /> True &nbsp;&nbsp;
                            <input {if (isset($data.returns) && ($data.returns == 0 ))}checked="checked"{/if} type="radio" name="returns" id="terminus-value-false-{$id}" id="" value="0" /> False<br />
                           <br /> Cancel Bubble:&nbsp;&nbsp;&nbsp;<input {if (isset($data.cancel) && ($data['cancel']=='Y'))}checked="checked"{/if} type="checkbox" value="Y" name="cancel" id="terminus-cancel-bubble-{$id}" /><br /><br />
                        </td>
                    </tr>
                    <tr>
