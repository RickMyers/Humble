    ...
    <tr>
        <td valign='middle'>
            ...
            <div id="process-internal-tab-{$id}" style='margin-left: auto; margin-right: auto; width: 545px'>
                <form name='process-form' id='humble-paradigm-config-process-internal-{$manager->getId()}' onsubmit='return false'>
                    ...
                    <div>
                        <div>
                            <select name='namespace' id='humble-paradigm-config-process-internal-form-namespace-{$manager->getId()}'>
                    ...
                    <script type='text/javascript'>
                        ...
                        Form.intercept($('#humble-paradigm-config-process-internal-{$manager->getId()}').get(),'{$manager->getId()}',false,'{$manager->getWindowId()}');
                        $('#view_code-{$manager->getId()}').on('click',(evt)=>{
                            ...
                            (new EasyAjax('/workflow/elements/explore')).add('window_id',win.id).packageForm('humble-paradigm-config-process-internal-{$manager->getId()}').then((response) => {
            ...
            <div id="process-external-tab-{$id}" style='margin-left: auto; margin-right: auto; width: 545px'>
                <div style='margin-left: auto; margin-right: auto; width: 545px'>
                    ...
                    <input type="hidden" name="id" id="humble-paradigm-config-process-external-form-id-{$id}" value="{$manager->getId()}" />                      
                    <select name='namespace' id='humble-paradigm-config-process-external-form-namespace-{$id}'>
                        <option value=''>Please choose from this list</option>
                    ...
                    <br />
                    <select name='component' id='humble-paradigm-config-process-external-form-component-{$id}'>
                        <option value=''>Please choose from this list</option>
                    </select>
