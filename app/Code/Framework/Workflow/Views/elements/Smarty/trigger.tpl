        ...
        <td valign='middle'>
            ...
            <div style='margin-left: auto; margin-right: auto; width: 545px'>
                ...
                <table>
                    ...
                    <tr>
                        <td colspan="2" ><input type="checkbox" name="active" id="humble-paradigm-config-trigger-form-active-{$manager->getId()}" />
                        When this checkbox is clicked, this event is active and can be triggered</td>
                    </tr>                    
                </table>
...
<script type='text/javascript'>
    ...
    <h1>{$method} - {$component} - {$manager->getNamespace()}</h1>
{else}
<table style='width: 100%; height: 100%;'>
    <tr>
        <td valign='middle'>
