...
<!-- ################################ END HEADER SECTION ########################################-->    
    <tr>
        <td colspan="3" align="center" valign="middle">
            <!-- ########################## FORM SECTION ########################################-->
            <form name="config-addamount-form" id="form-{$data.id}" onsubmit="return false">
                ...
                <fieldset style="padding: 10px; width: 600px; text-align: left"><legend>Instructions</legend>
                    Below identify the field on the event that we are going to add a static amount to, and what that amount should be<br /><br />
                    Field: <input class='paradigm-config-form-field' type="text" name="field" id="field_{$data.id}" value="{if (isset($data.field))}{$data.field}{/if}" /><br /><br >
                    Amount: <input class='paradigm-config-form-field' type="text" name="amount" id="amount_{$data.id}" value="{if (isset($data.amount))}{$data.amount}{/if}" /><br /><br ><br />
