        ...
        <td colspan="3" align="center" valign="middle">
            ...
            <form name="form-{$data.id}" id="form-{$data.id}" onsubmit="return false">
                ...
                <fieldset style="padding: 10px; width: 600px; text-align: left"><legend>Instructions</legend>
                    How many rows should be bulked together per event<br /><br />
                    <input class='paradigm-config-form-field' type="text" name="bulk_amount" value="{if (isset($data.bulk_amount))}{$data.bulk_amount}{/if}" /><br /><br >
