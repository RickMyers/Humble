...
<table style="width: 100%; height: 100%; border-spacing: 1px;">
    ...
    <tr>
        <td colspan="3" align="center" valign="middle">
            <form name="config-role-form" id="config-role-form-{$data.id}" onsubmit="return false">
...
<script type="text/javascript">
    Form.intercept($('#config-role-form-{$data.id}').get(),'{$data.id}','/paradigm/element/update',"{$helper->getWindowId()}");
</script>