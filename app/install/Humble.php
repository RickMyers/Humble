...
FACTORY;
    ...
    file_put_contents('app/Code/'.$project->package.'/'.$project->module.'/etc/application.xml',str_replace($srch,$repl,file_get_contents('app/Code/Framework/Humble/lib/sample/install/Code/Framework/Humble/etc/application.xml')));
    print("\n\n");
