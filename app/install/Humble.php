...
FACTORY;
    ...
    $cmd = \Environment::PHPLocation().' CLI.php --b namespace='.$project->namespace.' package='.$project->package.' module='.$project->module.' prefix='.$project->namespace.'_ '. 'author='.$project->author;
    print("\nExecuting: ".$cmd."\n\n");
    exec($cmd,$output);
    chdir('..');
    @unlink('humble.bat');
