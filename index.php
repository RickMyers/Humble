...
//$headers                = getallheaders(); //not needed in all cases
...
$test_mode              = ((!$is_production) && (isset($_REQUEST['TEST_MODE']) && strtolower($_REQUEST['TEST_MODE'])==='true'));
...
if (file_exists('Code/'.$project->package.'/'.$project->module.'/includes/Custom.php')) {
    include 'Code/'.$project->package.'/'.$project->module.'/includes/Custom.php';
}
...
if ($admin && !$logged_in) {
    if (\Environment::logAdminIn()) {
        $logged_in = $_SESSION['uid'];
    }
}
...
if (file_exists('Code/'.$project->package.'/'.$project->module.'/includes/includes/Headers.php')) {
    include 'Code/'.$project->package.'/'.$project->module.'/includes/Headers.php';
} else {
